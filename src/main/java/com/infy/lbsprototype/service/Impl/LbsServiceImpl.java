...
public class LbsServiceImpl implements LbsService {
	...
	@Override
	public GetMyNewsStoriesJsonData getMyNewsStories(InputRequest customer) {
		GetMyNewsStoriesJsonData getMyNewsStoriesJSONobj = lbsDao.getMyNewsStoriesDAO(customer.getCustomerId(),customer.getRegionCode());
		return getMyNewsStoriesJSONobj;
	}
